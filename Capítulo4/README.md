...
**Paso 2.** En la lista de soluciones, selecciona la solución no administrada que deseas exportar y luego selecciona `Exportar`. Ten en cuenta que no puedes exportar soluciones administradas.
