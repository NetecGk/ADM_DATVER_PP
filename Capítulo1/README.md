...
**Paso 1.** Abre tu navegador y ve al Centro de administración de Power Platform (PPAC): [admin.powerplatform.microsoft.com](url). Inicia sesión con tu cuenta de administrador que tenga los permisos necesarios (admin del servicio, admin global, o admin de Power Platform).
