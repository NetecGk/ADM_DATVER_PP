...
- Demostrar la capacidad de crear y personalizar un entorno aandbox de Power Platform y establecer sus configuraciones iniciales (tipo, región, base de datos) para usarlo como espacio seguro de desarrollo y prueba.
